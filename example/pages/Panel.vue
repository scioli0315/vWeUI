<template>
  <Page desc="面板" title="Panel">
    <div class="page__bd">
      <PanelGroup title="图文组合列表">
        <Panel>
          <template #icon>
            <img
              alt=""
        ...
        <template #ft>
          <Cell access link>查看更多</Cell>
        </template>
      </PanelGroup>

      <PanelGroup title="文字组合列表">
        <Panel>
          标题一
          <template #desc>
            由各种物质组成的巨型球状天体，叫做星球。星球有一定的形状，有自己的运行轨道。
        ...
        <template #ft>
          <Cell active link>查看更多</Cell>
        </template>
      </PanelGroup>

      <PanelGroup title="小图文组合列表">
        <Cell access>
          <template #icon>
            <img
              alt=""
